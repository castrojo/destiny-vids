...
this pass actually removes it, and fills every slot with picture:
  ...
  * the former Cortney interruption is moved to Act II, where its original
    source pointers belong; this act now carries the musical bed continuously.
...
**One clock.** Every shot advances wall and the bed together. Act VI's former
pause now belongs to Act II, so this musical is once again a continuous song.
...
ACT3C_IN = 322.200         # BED clock: the montage's measured handoff
...
def main():
    ...
    out = {
        ...
        "note": "AUTHORED shotlist, not a story.py output. A TIMING PASS: "
                ...
                "Every shot advances the continuous bed; the Cortney "
                "interruption belongs to Act II.",
        "unresolved": [],
        "shots": t.shots,
    }
