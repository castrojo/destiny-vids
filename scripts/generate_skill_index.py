...
Ported from projectbluefin/common (scripts/generate_skill_index.py) so this
repo's catalog obeys the same contract. Keep the two in sync when the upstream
generator changes; the only intentional divergence is the `category` enum in
