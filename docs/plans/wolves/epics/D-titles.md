...
**Automatable:** no — blocked on the owner deciding whether a title nobody
authored may appear beside a real contributor's face at all. J4 reviews the
*words* (CoC and wording), not whether titles may be generated in the first
place, so J4 is necessary but not sufficient.
