...
Thirty cards in all — fifteen name plates, twelve dialogue pills, a chapter
card, the patch-queue HUD and the villain's bar — generated by `scripts/build_efmb_plates.py` into
