...
Generated: 2026-08-15 · schema 1.0 · 13 skills

| id | category | status | one-line purpose |
|---|---|---|---|
| [audio](audio/SKILL.md) | editing | active | Source the best audio that exists, keep the chain lossless, and gate the delivered peak. |
...
| [review](review.md) | editing | active | Turn a watched-programme timecode into a one-act rebuild. |
