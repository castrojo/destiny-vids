...
|---|---|---|---|
| [chapters](chapters.md) | editorial | procedure | Author a chapter's on-screen copy in one Markdown file per chapter. |
| [farm](farm.md) | operations | runbook | Run frame-touching encodes on the remote Kubernetes farm. |
| [hive](hive.md) | media-production | procedure | Build the Season of the Blueberries episodes and the full-season cut, or integrate the authored Expansion Pack. |
