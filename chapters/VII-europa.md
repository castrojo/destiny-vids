...
# 101.200 + act I 116.200 + Perfume 2 66.400 + act II 364.000 + act III
...
# Perfume 4b 102.445 = 1539.793. Every `@` pin below was co-shifted by the
# same +35.526, so each plate's act-local seat is unchanged; the manifest
# regenerates byte-identical.
# Restate the derivation when the running order moves.
programme_start: 1539.793
...
- `@ 25:39.793` is programme time — the clock you scrub in the whole
  show. This act starts at 25:39.793.
...
[d01] krook @ 25:40.357 +1.6: Deploy CNCF Projects Team
  - avatar: ~/Videos/wolves-directors-cut/nimbatus-review/render/krook.png
  - fade_out_at: 1.864

[d02] preethit @ 25:42.357 +1.6: Stand down, I'm sending my wolf
  - fade_out_at: 3.864

[d03] alolita @ 25:44.357 +2.6: Are you sure the Kube is on Europa?
  - avatar: renders/avatars/alolita.png
  - fade_out_at: 6.864

[d04] preethit @ 25:47.357 +2.0: I hope she can handle the Kube
  - fade_out_at: 9.264

[d04b] preethit @ 25:49.757 +2.2: I must not fail
...
[d05] castrojo @ 26:04.357 +2.6: They must never know what you did for them
  - avatar: renders/avatars/castrojo.png
  - fade_out_at: 26.864

[d06] mrbobbytables @ 26:07.357 +2.0: When all hope is lost
  - avatar: renders/avatars/mrbobbytables.png
  - fade_out_at: 29.264

[d07] jeefy @ 26:09.757 +2.2: Standing by for Extraction
  - avatar: renders/avatars/jeefy.png
  - fade_out_at: 31.864

[d08] ihor @ 26:12.357 +2.2: G{k8s}dspeed
  - avatar: renders/avatars/idvoretskyi.png
  - fade_out_at: 34.464

[d11] preethit @ 26:14.957 +2.2: Our clan
...
[d09] nimbatus @ 26:41.357 +1.8: Wilco
  - avatar: ~/src/website/public/wolves/characters/nimbatus.webp
  - fade_out_at: 63.064

[d10] nimbatus @ 26:43.557 +2.0: {k8s}ut
  - avatar: ~/src/website/public/wolves/characters/nimbatus.webp
  - fade_out_at: 65.464

preethit @ 26:50.526: Hummingbird will find the girl
