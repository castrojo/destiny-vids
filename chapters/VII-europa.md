...
# `trim_to`/`dur` outranks a probe; otherwise the v:0 stream duration) --
# prologue 101.200 + act I 118.200 + Perfume 2 66.400 + act II 364.000 +
# act III 168.600 + Perfume 3 114.848 + intermission 27.194 + act IV 34.000
# + act V 25.259 + interstitial 5.000 + act VI 411.527 + Perfume 4a 13.120 +
# Perfume 4b 115.565 = 1564.913. Every `@` pin below was co-shifted by the
# same +60.646, so each plate's act-local seat is unchanged; the manifest
# regenerates byte-identical.
# Restate the derivation when the running order moves.
programme_start: 1564.913
...
- `@ 26:04.913` is programme time — the clock you scrub in the whole
  show. This act starts at 26:04.913.
...
[d01] krook @ 26:05.477 +1.6: Deploy CNCF Projects Team
  - avatar: ~/Videos/wolves-directors-cut/nimbatus-review/render/krook.png
  - fade_out_at: 1.864

[d02] preethit @ 26:07.477 +1.6: Stand down, I'm sending my wolf
  - fade_out_at: 3.864

[d03] alolita @ 26:09.477 +2.6: Are you sure the Kube is on Europa?
  - avatar: renders/avatars/alolita.png
  - fade_out_at: 6.864

[d04] preethit @ 26:12.477 +2.0: I hope she can handle the Kube
  - fade_out_at: 9.264

[d04b] preethit @ 26:14.877 +2.2: I must not fail
...
[d05] castrojo @ 26:29.477 +2.6: They must never know what you did for them
  - avatar: renders/avatars/castrojo.png
  - fade_out_at: 26.864

[d06] mrbobbytables @ 26:32.477 +2.0: When all hope is lost
  - avatar: renders/avatars/mrbobbytables.png
  - fade_out_at: 29.264

[d07] jeefy @ 26:34.877 +2.2: Standing by for Extraction
  - avatar: renders/avatars/jeefy.png
  - fade_out_at: 31.864

[d08] ihor @ 26:37.477 +2.2: G{k8s}dspeed
  - avatar: renders/avatars/idvoretskyi.png
  - fade_out_at: 34.464

[d11] preethit @ 26:40.077 +2.2: Our clan
...
[d09] nimbatus @ 27:06.477 +1.8: Wilco
  - avatar: ~/src/website/public/wolves/characters/nimbatus.webp
  - fade_out_at: 63.064

[d10] nimbatus @ 27:08.677 +2.0: {k8s}ut
  - avatar: ~/src/website/public/wolves/characters/nimbatus.webp
  - fade_out_at: 65.464

preethit @ 27:15.646: Hummingbird will find the girl
